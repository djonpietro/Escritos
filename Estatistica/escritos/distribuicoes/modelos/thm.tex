...
\newtheorem{def:uniforme continua}[def:base-modelos]{Definição}
\newtheorem{def:exponencial}[def:base-modelos]{Definição}
\newtheorem{def:gama}[def:base-modelos]{Definição}
\newtheorem{def:chi quadrado}[def:base-modelos]{Definição}
\newtheorem{def:cauchy}[def:base-modelos]{Definição}
\newtheorem{def:weilbull}[def:base-modelos]{Definição}
\newtheorem{def:beta}[def:base-modelos]{Definição}
\newtheorem{def:lognormal}[def:base-modelos]{Definição}
\newtheorem{def:laplace}[def:base-modelos]{Definição}
...
\newtheorem{prop:aproximacao poisson da binomial}[prop:base-modelos]{Proposição}
...
\newtheorem{prop:uniforme continua}[prop:base-modelos]{Proposição}
\newtheorem{prop:transformacao uniforme continua}[prop:base-modelos]{Proposição}
\newtheorem{prop:exponencial}[prop:base-modelos]{Proposição}
\newtheorem{prop:gama}[prop:base-modelos]{Proposição}
\newtheorem{prop:mgf gama}[prop:base-modelos]{Proposição}
\newtheorem{prop:relacao gama e poison}[prop:base-modelos]{Proposição}
\newtheorem{prop:chi quadrado}[prop:base-modelos]{Proposição}
\newtheorem{prop:chi quadrado e normal}[prop:base-modelos]{Proposição}
\newtheorem{prop:cauchy nao tem momentos}[prop:base-modelos]{Proposição}
\newtheorem{prop:mediana de cauchy}[prop:base-modelos]{Proposição}
\newtheorem{prop:lognormal}[prop:base-modelos]{Proposição}
...
\newtheorem{thm:desigualdade de jansen}[thm:base-modelos]{Teorema}
...
\newtheorem{cor:variancia positiva}[cor:base-modelos]{Corolário}
...
\newtheorem{exp:hipergeometrica 2}[exp:base-modelos]{Exemplo}
\newtheorem{exp:geometrica 1}[exp:base-modelos]{Exemplo}
\newtheorem{exp:esperanca geometrica 1}[exp:base-modelos]{Exemplo}
\newtheorem{exp:uniforme continua}[exp:base-modelos]{Exemplo}
...
\newtheorem{obs:geometrica 1}[obs:base-modelos]{Observação}
\newtheorem{obs:geometrica 2}[obs:base-modelos]{Observação}
\newtheorem{obs:binomial negativa 1}[obs:base-modelos]{Observação}
\newtheorem{obs:binomial negativa 2}[obs:base-modelos]{Observação}
\newtheorem{obs:uniforme continua 1}[obs:base-modelos]{Observação}
\newtheorem{obs:exponencial 1}[obs:base-modelos]{Observação}
