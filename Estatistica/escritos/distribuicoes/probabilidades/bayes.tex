...
Se $E$ e $F$ são eventos de um espaço amostral $\Omega$, então
\[
...
Seja $\mathcal{E} = \{E_1, \ldots, E_n\}$ uma partição de um espaço amostral $\Omega$.
Se $E$ é um evento de $\Omega$, então
\[
