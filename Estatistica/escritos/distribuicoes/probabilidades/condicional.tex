...
Sejam $E$ e $F$ eventos de $\mathcal{B}$ com $P(F) \ne 0$.
...
% Mostrar que probabilidade condicional é uma medida de probabilidade
...
% Consertar a prova para conjuntos enumeráveis
