...
\item Escala Razão -- nessa escala, existe uma origem absoluta, e podemos dizer quantas
vezes um valor maior do que outro através de razões.
Um exemplo de variável nessa escala é o peso de um indivíduo.
Transformações do tipo lineares preservam a estrutura dessa escala, e podemos utilizar
