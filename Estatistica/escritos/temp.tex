...
% 	headsep = 1.2cm
% ]{geometry}
\usepackage[paperwidth=8in, paperheight=12in, margin=1.25in]{geometry}
\linespread{1.15}
...
% ================================================================
%  Blocos de código — sóbrio, coerente com o restante do texto
% ================================================================
\usepackage{listings}
\usepackage{xcolor}

\definecolor{codecomment}{gray}{0.45}
\definecolor{coderule}{gray}{0.5}

\renewcommand{\lstlistingname}{Código}

\lstdefinestyle{escritos}{
