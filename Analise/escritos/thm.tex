...
\newtheorem{def:cisao}[def:base2]{Definição}
...
\newtheorem{prop:vizinhanca}[prop:base2]{Proposição}
\newtheorem{prop:fecho e inclusao}[prop:base2]{Proposição}
\newtheorem{prop:complementar aberto}[prop:base2]{Proposição}
\newtheorem{prop:fechado}[prop:base2]{Proposição}
\newtheorem{prop:cisao}[prop:base2]{Proposição}
\newtheorem{prop:intervalos e cisao}[prop:base2]{Proposição}
% ------------------------- Teoremas   --------------------------------
...
\newtheorem{cor:fechado e aberto}[cor:base2]{Corolário}
