...
% ------------------------- Teoremas   --------------------------------
\newtheorem{thm:base2}{Proposição}[chapter]
\newtheorem{thm:reais incluem naturais}[thm:base2]{Teorema}
\newtheorem{thm:reais incluem inteiros}[thm:base2]{Teorema}
\newtheorem{thm:reais incluem racionais}[thm:base2]{Teorema}
