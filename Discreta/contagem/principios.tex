...
\[
  S: [r] \to A
\]
Quando $S$ for injetora, o arranjo é dito sem repetição. Se for bijetora, o arranjo
é chamado de permutação.
\end{def:arranjo}
...
\[
  \Arr{n, r} = \frac{n!}{(n-r)!}.
\]
As permutações correspondem ao caso em que $n = r$, e o número de permutações de tamanho
$n$ será dado simplesmnte por:
\[
    \Pm{n} = n!
\]
