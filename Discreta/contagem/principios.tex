...
Outro corolário interessante do PFC é:
...
um arranjo de $r$ elementos $A$ se
\[
  S: [r] \to A
\]
...
\begin{proof}
  A diferença para uma função qualquer e que, a cada escolha feita para imagem
  de um elemento de $A$, o universo de escolhas é reduzido em 1. Com efeito,
